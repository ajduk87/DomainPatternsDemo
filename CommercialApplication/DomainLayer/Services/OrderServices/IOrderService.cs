...
namespace CommercialApplicationCommand.DomainLayer.Services.OrderServices
{
    public interface IOrderService
    {
        ...
        void Insert(IDbConnection connection, Order order, IDbTransaction transaction = null);
        long SelectLastOne(IDbConnection connection, Order order, IDbTransaction transaction = null);
