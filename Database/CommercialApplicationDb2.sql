...
(
	...
	ActionFirstQuarterSpecificProperty varchar(500) NULL,
	ActionSecondQuarterSpecificProperty varchar(500) NULL,
	ActionThirdQuarterSpecificProperty varchar(500) NULL,
	ActionForthQuarterSpecificProperty varchar(500) NULL
);
